...
avatar = {}
spellLib = {}
common.GetAddonName = function() 
	return "test" 
end
common.GetLocalDateTime = function()
	return { ["h"] = 5, ["min"] = 23, ["s"] = 24, ["ms"] = 546 }
end
common.LogInfo = function(...)
	print(...)
end
]]
...
local function widgettostring( widget )
	local api_type = apitype( widget )
	return s_format( "%s %s: \"%s\"", api_type, s_sub( tostring( widget ), -8 ), GetFullName( widget ) )
end
--------------------------------------------------------------------------------
